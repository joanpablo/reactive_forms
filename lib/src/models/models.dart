...
abstract class AbstractControl<T> {
  ...
  Map<String, dynamic> _defaultMessages = <String, String>{};
  bool _pristine = true;
  ...
  Map<String, String> get defaultMessages =>
      Map<String, String>.unmodifiable(_defaultMessages);
  ...
  Map<String, String> _runMessages() {
    final messages = <String, String>{};
    for (final validator in validators) {
      final error = validator.validate(this);
      if (error != null) {
        messages.addAll({validator.messageKey: validator.messageValue});
      }
    }
